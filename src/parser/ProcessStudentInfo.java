...
public class ProcessStudentInfo {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
        ...
        Map<String, List<parser.Student>> list = new LinkedHashMap<String, List<parser.Student>>();
				
				/*Declare 2 ArrayList with Student data type to store Selenium student into one of the ArrayList and
				  Qtp student into another ArrayList. */

        List<parser.Student> seleniumStudents = new ArrayList<parser.Student>();
        List<parser.Student> qtpStudents = new ArrayList<parser.Student>();
        ...
        Iterator<String> itr1 = list.keySet().iterator();
        while(itr1.hasNext()){
            System.out.println(itr1.next());
        }
        Iterator<List<parser.Student>>itr = list.values().iterator();
        while(itr.hasNext()){
